...
export class SQLiteAdapter {
    ...
    initializeOperations() {
        ...
        `).run(eventId, mailboxId, input.event_type, input.stream_type, input.stream_id, sequenceNumber, JSON.stringify(input.data), input.occurred_at || now, input.causation_id, input.correlation_id, JSON.stringify(input.metadata || {}));
                return {
