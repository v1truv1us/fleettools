...
export interface MissionStats {
  ...
  duration_ms?: number;  // Total mission duration
...
export interface CheckpointOps extends VersionedInterface {
  ...
  list(filter?: CheckpointDeleteFilter & { limit?: number }): Promise<Checkpoint[]>;
  delete(id: string): Promise<boolean>;
  markConsumed(id: string): Promise<void>;
  findPruneCandidates(options: PruneOptions & { mission_id?: string }): Promise<Checkpoint[]>;
}
...
export interface SpecialistOps extends VersionedInterface {
  ...
  getAll(filter?: { status?: SpecialistStatus }): Promise<Specialist[]>;
...
export interface MessageOps extends VersionedInterface {
  ...
  getByMailbox(mailboxId: string, filter?: { status?: MessageStatus; limit?: number }): Promise<Message[]>;
