...
export declare const AgentRegistrySchema: z.ZodObject<{
    ...
    id: string;
    created_at: string;
    agent_type: "full-stack-developer" | "code-reviewer" | "architect-advisor" | "backend-architect" | "infrastructure-builder" | "frontend-reviewer" | "api-builder-advanced" | "test-generator" | "security-scanner" | "deployment-engineer" | "monitoring-expert" | "accessibility-pro" | "ux-optimizer" | "compliance-expert" | "performance-engineer" | "database-expert";
    callsign: string;
    capabilities: {
        description: string;
        name: string;
...
export declare const AgentMessageSchema: z.ZodObject<{
    ...
    data: z.ZodObject<{
        ...
        message_id: string;
        from_agent: string;
        message_type: "task_assignment" | "task_acceptance" | "task_progress" | "task_completion" | "coordination_request" | "coordination_response" | "task_failure" | "resource_request" | "resource_release" | "handoff_request" | "handoff_acceptance" | "status_update" | "error_report";
        subject: string;
        ...
        subject: string;
        content: Record<string, unknown>;
        priority?: "medium" | "low" | "high" | "critical" | "emergency" | undefined;
        to_agent?: string | undefined;
        correlation_id?: string | undefined;
...
export declare const AgentTerminatedSchema: z.ZodObject<{
    ...
    data: z.ZodObject<{
        ...
        reason: "error" | "completed" | "timeout" | "manual" | "resource_limit" | "escalation";
        callsign: string;
        agent_id: string;
...
export declare const AgentCoordinationSchema: z.ZodObject<{
    ...
    data: z.ZodObject<{
        ...
        status: "in_progress" | "completed" | "failed" | "initiated";
...
export declare const AgentFileHandoffSchema: z.ZodObject<{
    ...
    data: z.ZodObject<{
        ...
        from_agent: string;
        to_agent: string;
        handoff_type: "review" | "edit_continuation" | "testing" | "deployment";
        handoff_id: string;
        file_path: string;
        handoff_status: "accepted" | "in_progress" | "completed" | "failed" | "requested";
        requested_at: string;
        context?: Record<string, unknown> | undefined;
        completed_at?: string | undefined;
...
export declare const TaskDependencySchema: z.ZodObject<{
    ...
    dependency_type: "data" | "completion" | "success" | "resource";
