...
import { initializeProject, getAvailableTemplates, getTemplateInfo, saveProjectConfig, loadGlobalConfig, ensureDirectories, colorize } from '@fleettools/fleet-shared';
export function registerInitCommand(program) {
    program
        ...
        try {
            ...
            const project = initializeProject(join(process.cwd(), projectPath), projectConfig.template || options.template, projectConfig);
            // Save configuration
