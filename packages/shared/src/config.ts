 ...
 */
export function getDefaultGlobalConfig(): FleetGlobalConfig {
 ...
 */
export function loadProjectConfig(): FleetProjectConfig | null {
 ...
 */
export function getDefaultProjectConfig(): FleetProjectConfig {
  return {
    name: 'fleet-project',
    version: '1.0.0',
    fleet: {
 ...
 */
function getProjectConfigWithDefaults(userConfig: any): FleetProjectConfig {
 ...
 */
export function saveProjectConfig(config: FleetProjectConfig): void {
  const configPath = getProjectConfigPath();
  const content = stringifyYaml(config);
  writeFileSync(configPath, content, 'utf-8');
}
 ...
 */
export function ensureDirectories(config: FleetGlobalConfig): void {
  const dirs = [
